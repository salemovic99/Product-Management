        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center space-x-3">
              ...
              <div className=''>
                <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">Locations</h1>
                <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Manage your Locations</p>
              </div>
            </div>
